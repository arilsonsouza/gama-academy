...
const PokeCard = ({ id, name, url, image_url, regular_price, sale_price, on_sale}) => {
  ...
  const handleClick = () => {
    dispatch(addItemToCart({item: { id, name, url, image_url, regular_price, sale_price, on_sale}}))
  }

  return (
    <>
      <div className="tw-w-full tw-flex tw-flex-col tw-justify-end tw-rounded tw-shadow-xl tw-border-solid tw-border-2 tw-border-gray-400 poke__card">
